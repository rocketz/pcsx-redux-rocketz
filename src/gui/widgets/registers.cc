    ...
    if (ImGui::BeginTabBar(_("Registers"))) {
        ...
        if (ImGui::BeginTabItem("GPR")) {
            ...
            for (auto& reg : registers->GPR.r) {
                ...
                if (ImGui::InputText(label, &val, ((counter == 0) ? ImGuiInputTextFlags_ReadOnly : 0) | ImGuiInputTextFlags_CharsHexadecimal | ImGuiInputTextFlags_EnterReturnsTrue | ImGuiInputTextFlags_AutoSelectAll)) {
                ...
                if (counter > 0) {
                    ...
                    if (ImGui::InputText(label2, &val2, ImGuiInputTextFlags_CharsDecimal | ImGuiInputTextFlags_EnterReturnsTrue |
